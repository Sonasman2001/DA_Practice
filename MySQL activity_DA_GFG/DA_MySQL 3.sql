...
CREATE TABLE IF NOT EXISTS shopmart.users (
...
CREATE TABLE IF NOT EXISTS shopmart.inventory (
...
CREATE TABLE IF NOT EXISTS shopmart.transactions (
    ...
    date_time TIMESTAMP,
    FOREIGN KEY (product_id) REFERENCES shopmart.inventory(product_id),
    FOREIGN KEY (user_id) REFERENCES shopmart.users(user_id)
);